          ...
          <div className="row">
            <div className="col-12 col-md-6 col-lg-4">
              <div className="footer__section -info">
                ...
                <p>
                  Local: <span>{footerInfomation.address}</span>
                </p>
                <p>
                  Telefone: <span>{footerInfomation.phone}</span>
                </p>
                <p>
                  Email: <span>{footerInfomation.email}</span>
                </p>
                <p>
                  Funcionamento: <span>{footerInfomation.open}</span>
                </p>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-4">
              <div className="footer__section -links">
                <div className="row">
                  <div className="col-12 col-sm-6">
                    <h5 className="footer-title">Conta</h5>
                    <ul>
                  ...
                  <div className="col-12 col-sm-6">
                    <h5 className="footer-title">Infomação</h5>
                    <ul>
            ...
            <div className="col-12 col-lg-4">
              <div className="footer__section -payment">
                <h5 className="footer-title">Métodos de pagamento</h5>
                <p>
                 Fazemos de tudo para cobrir todos os metodos de pagamentos disponíveis{" "}
                </p>
